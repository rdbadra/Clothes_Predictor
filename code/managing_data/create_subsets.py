...
def createSubsets():
    ...
    writeSubset(os.getcwd()+"/../../subsets/subset1.txt", subset1)
    writeSubset(os.getcwd()+"/../../subsets/subset2.txt", subset2)
    writeSubset(os.getcwd()+"/../../subsets/subset3.txt", subset3)
    dic=dc.getDictionaryWithCategories(os.getcwd()+"/../../subsets/subset1.txt")
    print("Subset 1: ")
    print(dic)
    print(dc.getTotalNumberOfValuesInDictionary(dic))
    dic=dc.getDictionaryWithCategories(os.getcwd()+"/../../subsets/subset2.txt")
    print("Subset 2: ")
    print(dic)
    print(dc.getTotalNumberOfValuesInDictionary(dic))
    dic=dc.getDictionaryWithCategories(os.getcwd()+"/../../subsets/subset3.txt")
    print("Subset 3: ")
    print(dic)
    print(dc.getTotalNumberOfValuesInDictionary(dic))
